            ...
            <div class="col">
               <div class="row" style="height: 120px;" id="backimg">
                    <div class="col" style="text-align: center; align-self: center;">
		              ...
		              <form id="writeForm" action="../board/updateContentProcessfr.do" method="POST">
                       <div class="row mt-3 mb-3">
                        <div class="col">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-default">이름</span>
                                <span class="form-control" name="member_name" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" style="text-align: center">${content.memberVo.member_name }</span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="idTitle" name="board_title" class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" value="${content.bulletinBoardVo.board_title }">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-floating">
                                <textarea class="form-control" id="idContent" name="board_content" placeholder="Leave a comment here"
                                    style="height: 400px">${content.bulletinBoardVo.board_content }</textarea>
                    ...
                    <div class="row">
                        <div class="form-col mt-3" style="text-align:end;">
                            <a href="../board/bulletinBoard_mainfr.do"><button type="button" class="btn btn-success" style="border-radius:5px;">목록</button></a>
                            <input type="submit" class="btn btn-success" value="수정" style="border-radius:5px; margin-left: 10px;">
                        </div>
                    </div>
                </form>
