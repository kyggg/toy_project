	           ...
	           <div class="col">
                    ...
                    <div class="col">
                        <table class="table table-hover">
                            ...
                            <tbody style="text-align: center;">
								...
								<tr>
									<td>${data.bulletinBoardVo.board_no }</td>
									...
									<td><a style="text-decoration:none; color:black;" href="./readContentPagefr.do?board_no=${data.bulletinBoardVo.board_no }">${data.bulletinBoardVo.board_title }</a>
										<c:if test="${!empty data.newTime }">
											<span class="badge rounded-pill bg-danger">new</span>
										</c:if></td>
									<td>${data.bulletinBoardVo.board_readcount }</td>
									<td><fmt:formatDate value="${data.bulletinBoardVo.board_writedate }"
											pattern="yy.MM.dd" /></td>
								</tr>
							          ...
							          <div class="modal-dialog">
							              <div class="modal-content">
							                  ...
							                  <div class="modal-body" style="background-color: #fff;">
							                      <form id="writeForm" action="../message/BoardFrwriteMessageProcess.do" method="post" >
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-2 mt-2" style="align-self: center; text-align: end; margin: auto;">
                        <button onClick="location.href='../board/board_writefr.do'" class="btn btn-success" style="padding: 7px; color:#fff; text-align: center; ">글쓰기</button>
                    </div>
