            ...
            <div class="col">
               <div class="row" style="height: 120px;" id="backimg">
                    <div class="col" style="text-align: center; align-self: center;">
		              ...
		              <form id="writeForm" action="./updateContentProcess.do" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="idTitle" name="tech_title" class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" value="${content.techVo.tech_title }">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-floating">
                                <textarea class="form-control" id="idContent" name="tech_content" placeholder="Leave a comment here"
                                    style="height: 400px">${content.techVo.tech_content }</textarea>
