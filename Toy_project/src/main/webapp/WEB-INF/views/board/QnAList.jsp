	           ...
	           <div class="col">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody style="text-align: center;">
                              ...
                              <c:forEach items="${contentlist }" var="data" varStatus="vs">
									<tr>
										<th scope="row">${data.boardVo.no }</th>
										...
										<td><a style="text-decoration:none; color:black;"href="./readContentPageQa.do?board_no=${data.boardVo.board_no }">${data.boardVo.board_title }</a>
							          ...
							          <div class="modal-dialog">
							              <div class="modal-content">
							                  ...
							                  <div class="modal-body" style="background-color: #fff;">
							                      <form id="writeForm" action="../message/BoardQawriteMessageProcess.do" method="post" >
        		...
        		<div class="row mt-2">
					...
					<div class="col-2 mt-2" style="align-self: center; text-align: end; margin: auto;">
						<button onClick="location.href='../board/QnAWrite.do'" class="btn btn-success" style="padding: 7px; color:#fff; text-align: center; ">글쓰기</button>
					</div>

				</div>

            </div>
            <div class="col-2"style="align-self: center; text-align: center; height: auto; margin-top: -2px;">
            	<div class="row">
					<div class="col">            
