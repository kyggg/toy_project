		...
		<div class="container-fulid" id="container">
            ...
            <div class="col">
                 <div class="row" style="height: 120px;" id="backimg">
                    <div class="col" style="text-align: center; align-self: center;">
                        <h1 style="color:#ffffff; "><strong>QnA</strong></h1>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered" style="height: auto; align-self: center; margin: 0px;">
                        <div class="col">
                            <tr style="text-align: center;">
                                ...
                                <td>${content.boardVo.board_readcount }</td>

                                <td style="width:15%; background: rgb(202, 200, 200);">좋아요</td>
                                <td>${content.countLike }</td>
                            </tr>
                        </div>
                        <div class="col">
                            <tr style="text-align: center;">
                                <td style="background: rgb(202, 200, 200);">제목</td>
                                <td colspan="5">${content.boardVo.board_title }</td>
                            </tr>
                        </div>
                ...
                <div class="row mt-3">
		                ...
		                <c:if test="${!empty sessionUser }">
		                    <c:choose>
						    	<c:when test="${!empty sessionUser && sessionUser.member_no == content.like.member_no  }">
						    		<a href="./deleteLikeQa.do?like_no=${content.like.like_no}&&board_no=${content.boardVo.board_no}">
		                        <button type="button" class="btn btn-outline-danger">좋아요 <i class="bi bi-heart-fill"></i></button></a>
						    	</c:when>
						    	<c:otherwise>
						    		<a href="./setLikeQa.do?member_no=${sessionUser.member_no }&&board_no=${content.boardVo.board_no}">
                    ...
                    <div class="col" style="text-align:end;">
                        <c:if test="${!empty sessionUser && sessionUser.member_no == content.memberVo.member_no }">
                       	<a href="./deleteContentProcessQa.do?board_no=${content.boardVo.board_no}"><button type="button" class="btn btn-danger" style="border-radius:5px;">삭제</button></a>
                        <a href="./modifyContentPageQa.do?board_no=${content.boardVo.board_no}"><button type="button" class="btn btn-success" style="border-radius:5px; margin-left: 10px;">수정</button></a>
                        </c:if>
                        <a href="../board/QnAList.do"><button type="button" class="btn btn-success" style="border-radius:5px; margin-left: 10px;">목록</button></a>
                    </div>
                </div>
                ...
                <div class="row mt-3">
					...
					<form action="writeCommentProcess.do" method="post">										
                          ...
                          <c:if test="${!empty sessionUser }">
                               <input type="text" class="form-control" placeholder="댓글을 써주세요." aria-describedby="button-addon2" name="qacomment_content">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <hr>		  	
				  			작성자 : ${com.memberVo.member_name }<br>
				  			작성일 : <fmt:formatDate value="${com.commentVo.qacomment_date }" pattern="yy-MM-dd" /><br>
				  			내용 : ${com.commentVo.qacomment_content }
	                    </c:forEach>
		  				</c:if>
                    </table>
                    </div>
