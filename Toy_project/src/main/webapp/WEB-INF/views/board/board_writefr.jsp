            ...
            <div class="col">
                <div class="row" style="height: 120px;" id="backimg">
                 ...
                 <div class="row mt-3 mb-3">
				    <form id="writeForm" action="../board/writeProcessfr.do" method="post" enctype="multipart/form-data">
		                    <div class="row">
		                        <div class="col">
		                    ...
		                    <div class="row">
		                        <div class="col">
		                            <div class="input-group mb-3">
		                                ...
		                                <input type="text" id="idTitle" name="board_title" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="row">
		                        <div class="col">
		                            <div class="form-floating">
		                                <textarea class="form-control" id="idContent" name="board_content" placeholder="Leave a comment here" style="height: 400px"></textarea>
                    	...
                    	<div class="col">
							...
							<input id="inpFile" class="form-control form-control-user" type="file" name="bulletinboard_files"  multiple class="form-control" accept="image/*" style="margin-top: 35px;">
						</div>
<!--                         <div class="col"> -->
<!--                             <div class="input-group mt-3"> -->
<!--                                 <input type="file" accept="image/*" name="bulletinboard_files" multiple class="form-control" aria-label="Sizing example input" -->
