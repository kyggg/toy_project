		...
		<div class="container-fulid" id="container">
            ...
            <div class="col">
               <div class="row" style="height: 120px;" id="backimg">
                ...
                <form action="./writeContentProcessQa.do"  method="POST">
                   <div class="row mt-3 mb-3">
                        <div class="col">
                            <div class="input-group">
                                <span class="input-group-text" id="inputGroup-sizing-default">이름</span>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="member_name" size="30" value="${sessionUser.member_name}" readonly>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="board_title" class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" value="${readContent.boardVo.board_title}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <!-- <textarea>사이가 value값</textarea> -->
                                <textarea name="board_content" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                    style="height: 300px">${readContent.boardVo.board_content}</textarea> 
                    ...
                    <div class="row">
                        <div class="form-col mt-3" style="text-align:end;">
                            <a onClick="location.href='../board/QnAList.do'" class="btn btn-success" style="padding: 7px; color:#fff; text-align: center; ">목록</a>
                            <button type="submit" class="btn btn-success" style="padding: 7px; color:#fff; text-align: center; margin-left: 5px; width: 100px;  ">작성</button>
                        </div>
                    </div>
              	</form>
            </div>
