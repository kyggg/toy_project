                        ...
                        <table class="table" >
                            <thead>
                                <tr style="text-align: center; color:#1AAB8A;">
                                    ...
                                    <th scope="col" >판매자</th>                                                                 
                                    <th scope="col" >가게등록일</th>
                                    
                                </tr>
                            </thead>
                            <tbody style="text-align: center; back">                           
                               	<c:forEach items="${likeList }" var="data">
								<tr>
									<td>${data.toyShopLikeVo.like_no }</td>
									<td><a style="text-decoration:none; color:black;" href="./Shop_ClientProductView.do?shop_no=${data.shopVo.shop_no }">${data.shopVo.shop_name }</a></td>
