    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="border-top my-3"></li>
		...
		<div class="row" style="margin-top: 80px;">
			...
			<hr style="margin-bottom: 41px;">	

			<div class="row" style="display: flex; justify-content: start;">
				<c:forEach items="${productlist}" var="productlist">
							<div class="col-4" style="align-self: center;width: 250px; height:530px; margin-top:0px; margin-left: 40px;">
								<div class="card" style=" width: 280px; height:510px;border-radius: 15px;  mergin-bottom:50px; ">									  
									  <c:choose>
											<c:when test="${empty productlist.toyProductVo.product_image_url}">
												<img src="../resources/img/noimg1.jpg" class="card-img-top" alt="..." style="																									    
																	    ...
																	    background-position: center;width: 268px; height:350px;">
									    	</c:when>
									    	<c:otherwise>	
