    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="border-top my-3"></li>
		...
		<div class="row" style="margin-top: 100px;">
			<div class="col" style="font-size: 30px">${content.shopVo.shop_name }<span style="font-size: 16px; margin-left: 10px;"><i class="bi bi-gem" style="color:#1AAB8A; font-size: 16px; margin-left:10px;"></i>찜${getLike.likecount}</span></div>
			
			<div class="col" style=" font-size: 20px; text-align: end; margin-right: 50px; margin-top:20px;">
				<c:if test="${!empty sessionUser }">
		                    <c:choose>
						    	<c:when test="${!empty sessionUser && sessionUser.member_no == getLike.like.member_no  }">
						    		<a href="deleteLike.do?member_no=${sessionUser.member_no }&&shop_no=${content.shopVo.shop_no}" style="text-decoration:none; color:black;">
		                        <i class="bi bi-star-fill" style="color: yellow;"></i>찜</a>
						    	</c:when>
						    	<c:otherwise>
						    		<a href="setLike.do?member_no=${sessionUser.member_no }&&shop_no=${content.shopVo.shop_no}" style="text-decoration:none; color:black;">
						    		<i class="bi bi-star" style="color: yellow;"></i>찜하기</a>
						    	</c:otherwise>
						    </c:choose>
						 </c:if>
			</div>
			...
			<hr>	
		<div class="row-1" style="margin-top: 80px;">
			<div class="col" style="font-size: 28px; text-align: center;">Product List</div>
			</div>
			<div class="row" style="display: flex; justify-content: center;">
				<c:forEach items="${productlist}" var="productlist" end="7">
