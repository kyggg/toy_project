...
<div id="wrapper">
 ...
 <div class="container-fluid">
    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        <button class="btn btn-toggle align-items-center rounded collapsed" style="background-color:transparent;" >
          Purchase
        </button>
      </li>
      <li class="mb-1">
			...
			<div class="row" style="height: 120px;">
                ...
                <div class="row">
                    <div class="col">
                        <table class="table" >
                            <thead>
                                <tr style="text-align: center; color:#1AAB8A;">
                            ...
                            <tbody style="text-align: center; back">                           
                               	<c:forEach items="${purchaseHistory }" var="data">
								<tr>
									<td>${data.toyBuyVo.buy_no }</td>
									<td><a style="text-decoration:none; color:black;" href="./Shop_BuyProduct.do?product_no=${data.toyProductVo.product_no }">${data.toyProductVo.product_name }</a></td>
   									<td>${data.toyProductVo.product_price }</td>													
									<td>${data.toyBuyVo.buy_count }</td>									
									<td>${data.toyBuyVo.buy_address }</td>
									<td><fmt:formatDate value="${data.toyBuyVo.buy_date }"
