		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-8" style="margin-top: 60px; margin-bottom: 30px; margin-left:70px;font-size: 30px;">
					주문 완료</div>
				<div class="col" style="margin-top: 60px;text-align: center; "><span>01장바구니> 02주문/결제></span> <span style="font-size: 20px;color: #1AAB8A;">03주문완료</span></div>
				<hr>
			</div>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="row">
						...
						<div style="text-align: center; font-size: 40px;">주문이 성공적으로 완료되었습니다.</div>
						<div style="text-align: center; margin-bottom: 20px;">자세한 구매내역 확인은 주문내역에서 확인하실 수 있습니다.</div>
						<hr>
					</div>
					<div class="row" style="margin-top:20px;margin-bottom: 10px;">
						<div class="col-7" style="text-align: center; font-size: 20px;">주문번호
							<p style="margin-top:20px; color: #1AAB8A; ">019121312312312</p>
						</div>
						<div class="col-5" style="text-align: center; font-size: 20px;">주문금액
							<p style="margin-top:20px; font-size: 25px;">${productView.productVo.product_price }원</p>
						</div>
					</div>
					<hr>
					<div class="row">
