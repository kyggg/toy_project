...
<div id="wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8">
            	<div class="row">
            		<div class="col" style="margin-top: 60px; margin-bottom: 5px;font-size: 30px; text-align: left;"> 가게정보 수정</div>
            		<p>나만의 개성있는 가게를 등록하세요.</p>
            	</div>      
            	<hr style="border: 0; height: 3px; background: #1AAB8A;">
            <form id="writeForm" action="./updateShopProcess.do" method="POST" enctype="multipart/form-data">           
            	<div class="row" style="height: 200px;">
            		<div class="col-8" style="flex-direction: column;">            		       				
       				<div style="margin-bottom: 10px;"><span>가게 이름: </span><input type="text" value="${shopView.shopVo.shop_name }" class="form-control" name="shop_name" style="text-align: center; display: flex; justify-content: right; width: 400px;"></div>       			       			
            	...
            	<div class="row">
            		<div class="col">
            			...
            			<textarea class="form-control" id="idContent" name="shop_content" style="height: 250px"> ${shopView.shopVo.shop_content }</textarea>
            	 		<hr style="border: 0; height: 3px; background: #1AAB8A; margin-top:0;">     
            		</div>
            	</div>
            	<div class="row" >
            		<div class="col" style="display: flex; justify-content: center; ">       
            		<input type="hidden" name="shop_no" value="${shopView.shopVo.shop_no }">     
            			<button class="btn-lg btn-info" value="submit" style="font-size:1rem; padding: 6px 12px; background-color:transparent;  color:#1AAB8A;"><strong>수정</strong></button>
            			</div>
            			<div class="col" style="display: flex; justify-content: center; ">  
