		...
		<div class="row">
	           ...
	           <div class="col-8">
                ...
                <div class="row mt-3" style="height: 100px;" id="backimg">
                    <div class="col" style="text-align: center; align-self: center;">
                        <h1 style="color:#000000; "><strong>Send Message</strong></h1>
                    </div>
                </div>
                       ...
                       <table class="table">
						<thead>
							<tr style="text-align: center;">
								...
								<th scope="col" style = "width: 20%"><strong>받는 사람</strong></th>
								<th scope="col" style = "width: 40%"><strong>제목</strong></th>
								<th scope="col" style = "width: 20%"><strong>날짜</strong></th>
								<th scope="col" style = "width: 10%"><strong>확인</strong></th>
							</tr>
						</thead>
						<tbody style="text-align: center;">
							<c:forEach items="${sendmessageList }" var="message" varStatus="vs">
								<c:set var="i" value="${i+1 }"/>
								<tr>
									<td>${i }</td>
									
									
									<td><a style="text-decoration:none; color:black;" class="dropdown" href="#" role="button" data-bs-toggle="dropdown" > ${message.messageName.member_name }</a>
									...
									<td><a style="text-decoration:none; color:black"   href="./readsendMessage.do?message_no=${message.messageVo.message_no}" >${message.messageVo.message_title}</a></td>
									<td><fmt:formatDate value="${message.messageVo.message_writedate}" pattern="yy.MM.dd"/></td>
									<td>
										<c:choose>
											<c:when test="${message.messageVo.message_readcount eq 0 }">
											X
											</c:when>
										 	<c:otherwise>
										 	O
							                  ...
							                  <div class="modal-body" style="background-color: #fff;">
							                    ...
							                    <div>
							                              ...
							                              <input type="text" id="idTitle" name="" class="form-control" aria-label="Sizing example input"
							                                               aria-describedby="inputGroup-sizing-default" value="${message.messageName.member_name }"> 
							                          </div>
							                          <div>
							                              ...
							                              <input type="text" id="idTitle" name="member_receive_name" class="form-control" aria-label="Sizing example input"
							                                               aria-describedby="inputGroup-sizing-default" value="${message.messageVo.member_receive_name }"> 
							                          </div>
							                          <div>
