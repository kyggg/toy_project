		...
		<div class="row">
	           ...
	           <div class="col-8">
                ...
                <div class="row mt-3 mb-3">
                    <div class="col" style="text-align: center; align-self: center;">
                        <h1 style="color:#000000;"><strong>Read Message</strong></h1>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="card w-95">
					  <div class="card-body">
						    ...
						    <h5 class="card-title"> 	&nbsp;보낸사람: ${content.messageVo.member_send_name }</h5>
						    <div class="col mt-3">
						 	 ...
						 	 <div class="card">
								  ...
								  <div class="card-body">
								    <blockquote class="blockquote mb-0">
								      <p>${content.messageVo.message_content}</p>
								    </blockquote>
							  </div>
							</div>	
							</div>
					       <div class="form-col mt-3" style="text-align:end; padding :0px;">
                              <a href="./deletereceiveMessageProcess.do?message_no=${content.messageVo.message_no }"><button type="button" class="btn btn-danger" style="border-radius:5px; margin-left: 10px; width: 100px;">삭제</button></a>
                               	<a href="#" data-bs-toggle="modal" data-bs-target="#messageModalre"><button type="button" class="btn btn-primary" style="border-radius:5px; margin-left: 10px;width: 100px;">답장</button></a>
                               <a href="./messageList.do?member_name=${sessionUser.member_id }"><button type="button" class="btn btn-secondary" style="border-radius:5px; color: white; margin-left: 10px; width: 100px;">목록</button></a>
                           </div>
					 	 </div>
					</div>
              </div>
	                        ...
	                        <form id="writeForm" action="./writeMessageProcess.do" method="post" >
	                            <div>
	                                ...
	                                <input type="text" id="idTitle" name="member_receive_name" class="form-control" aria-label="Sizing example input"
                                                  aria-describedby="inputGroup-sizing-default" value="${content.messageVo.member_send_name }"> 
	                            </div>
	                            <div>
	                            ...
	                            <button type="submit" class="btn btn-success" style="border:0; float:right; margin-top: 10px;" ><strong>보내기</strong></button>
	                            <button type="button" class="btn btn-success" data-bs-dismiss="modal" style="border:0; float:right; margin-top: 10px;  margin-right:10px;" data-bs-dismiss="modal" ><strong>취소하기</strong></button>
	                        </form>
	                    </div>
	                </div>
	            </div>
